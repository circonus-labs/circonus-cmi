...
ChefNode.prototype._mergeAttributes = function(){
    ...
    util.mergeDeep(attributes, this.data.default);
    util.mergeDeep(attributes, this.data.force_default);
    util.mergeDeep(attributes, this.data.normal);
    util.mergeDeep(attributes, this.data.override);
    util.mergeDeep(attributes, this.data.force_override);
    util.mergeDeep(attributes, this.data.automatic);
